...
public class ExemploTreeMap {
    public static void main(String[] args) {
        ...
        //Retorna a primeira capital no topo da
        ...
        // Retorna a primeira capital no topo da arvore e removendo-a
        System.out.println(firstEntry.getKey() + " - " + firstEntry.getValue());

        // Retorna a primeira capital no final da arvore e removendo-a
